...
import { createStep1Schema, type Step1FormData } from "@/features/home/schemas/add-project";
...
export default function Step1({ onNext }: Step1Props) {
  ...
  return (
    <form
      ...
      className="flex w-full max-w-[600px] flex-col items-center gap-6 rounded-xl border border-neutral-200 bg-white px-5 py-6 shadow-sm sm:px-8 sm:py-8"
      dir={dir}
    >
      ...
      <div className="mt-4 flex w-full justify-center">
        <Button
          ...
          className="flex h-11 w-full items-center justify-center gap-2 rounded-[10px] bg-primary-300 px-6 font-semibold text-secondary-500 transition-all hover:bg-primary-300/90 active:translate-y-px disabled:opacity-50"
        >
